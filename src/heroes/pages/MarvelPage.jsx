  ...
  return (
    <>
      <h1 className="text-center font-bold text-6xl uppercase m-4">
        ...
        <br /> Mejores héroes de <span className="text-red-600">Marvel</span>
      </h1>
          ...
          >
            ...
            <div className="px-6 py-4">
              ...
              <Link to={`/heroe/${heroe.id}`}>
                <button className="w-full bg-cyan-500 px-8 py-2 mt-8 mb-6 rounded-lg uppercase font-bold hover:bg-cyan-700">
                  Ver Perfil
                </button>
              </Link>
            </div>
